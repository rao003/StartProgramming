...
# first clear the area2
mc.setBlocks(x+10, y, z-10, x+30, y+15, z+10, air)
# now lay a foundation
mc.setBlocks(x-7, y-1, z-7, x+7, y-3, z+7, stone)
# now lay a foundation2
mc.setBlocks(x+7, y-1, z-7, x+21, y-3, z+7, stone)
...
mc.setBlocks(x+7, y, z+7, x+7, y, z-7, fence)
mc.setBlocks(x+7, y, z+7, x-7, y, z+7, fence)
# add add a fence around our plot2
mc.setBlocks(x+7, y, z-7, x+21, y, z-7, fence)
mc.setBlocks(x+21, y, z+7, x+21, y, z-7, fence)
mc.setBlocks(x+7, y, z+7, x+21, y, z+7, fence)

# now make our house block
mc.setBlocks(x-5, y, z-5, x+5, y+9, z+5, 41)
# now make our house block2
mc.setBlocks(x+9, y, z-5, x+19, y+9, z+5, 41)

# and hollow it out
mc.setBlocks(x-4, y, z-4, x+4, y+8, z+4, air)
# and hollow it out2
mc.setBlocks(x+9, y, z-4, x+18, y+8, z+4, air)
